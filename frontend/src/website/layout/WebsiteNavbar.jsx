// src/website/layout/WebsiteNavbar.jsx
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/deals" className="text-gray-700 hover:text-red-600">Deals</Link>
            ...
            <form onSubmit={handleSearch} className="relative">
              <input
                ...
                className="pl-10 pr-4 py-2 border rounded-lg w-48 text-gray-900"
              />
            ...
            {/* Admin Link */}
            <Link to="/auth" className="text-gray-500 text-sm">Admin</Link>
          </div>
